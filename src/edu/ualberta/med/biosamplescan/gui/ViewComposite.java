...
import edu.ualberta.med.biosamplescan.widgets.PalletTableWidget;
...
public class ViewComposite extends ScrolledComposite {
    ...
    private PalletTableWidget[] tables;
        ...
        try {
            ...
            {// TODO this button is only for debugging purposes
                ...
                loadFromFile.addSelectionListener(new SelectionAdapter() {
                    public void widgetSelected(SelectionEvent evt) {
                        PalletSet plateSet =
                            ((PlateSetEditor) PlatformUI.getWorkbench()
            ...
            // pack();
            {
                ...
                tables = new PalletTableWidget[ConfigSettings.PLATENUM];
                tableColumns =
                    new TableColumn[ConfigSettings.PLATENUM][ConfigSettings.PLATENUM * 13];
                tableItems =
                    new TableItem[ConfigSettings.PLATENUM][ConfigSettings.PLATENUM * 8];
                ...
                for (int table = 0; table < ConfigSettings.PLATENUM; table++) {
                    ...
                    // plateIdText[table].setBounds(5 + 100 * table + 50, 30,
                    // 90,
                    // 18);
                                        ...
                                        for (int x = 0; x < plateSet
                                            ...
                                            try {
                                                if (plateSet.getPlate(i + 1) != null
                                                    && plateSet.getPlate(i + 1)[x][y] != null
                                                    && !plateSet
                                                        .getPlate(i + 1)[x][y]
                                                        .isEmpty()) {
                                                    emptyTable = false;
                    ...
                    tables[table] = new PalletTableWidget(section, SWT.NONE);
                    ...
                    // SWT.NONE);
                    // tableColumns[table][0].setWidth(ViewComposite.fontSize *
                    // 10
                ...
                if (plateBtn[p].getSelection()) {
                    for (int r = 0; r < 8; r++) {
                        for (int c = 0; c < 12; c++) {
                            ...
                            plateSet.setPlate(p + 1, null); // TODO TEST
                            // THIS!!!!!
