...
public class ConfigDialog extends org.eclipse.swt.widgets.Dialog {
    ...
    private void initCustomRoutines() throws InvalidFileFormatException,
        IOException {
        ...
        /*
         * InputStream stream =
         * ClassLoader.getSystemResourceAsStream("scanlib.ini"); Ini ini = new
         * Ini(stream); for (String key : ini.get("scanner").keySet())
         * 
         * { System.out.println("scanner/" + key + " = " +
         * ini.get("scanner").fetch(key)); }
         */

        /*
         * Ini ini = new Ini(); try { ini.load(new FileReader("scanlib")); }
