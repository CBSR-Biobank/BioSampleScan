package edu.ualberta.med.biosamplescan.sourceproviders;
...
public class DebugState extends AbstractSourceProvider {
    public final static String SESSION_STATE =
        "edu.ualberta.med.biosamplescan.sourceprovider.debugState";
